package com.example.messaging.azure.eventhub.kafka;
...
public class EventHubKafkaApiApplication {
    public static void main(String[] args) {
        SpringApplication.run(EventHubKafkaApiApplication.class, args);
    }
